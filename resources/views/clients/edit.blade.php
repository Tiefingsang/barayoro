...
<div :class="[$store.app.menu=='horizontal' ? 'max-w-[1704px] mx-auto xxl:px-0 xxl:pt-8':'',$store.app.stretch?'xxxl:max-w-[92%] mx-auto':'']" class="p-3 md:p-4 xxl:p-6 space-y-4 xxl:space-y-6">
    ...
    <div class="white-box xxxl:p-6">
        <div class="n20-box xxxl:p-6 relative ltr:bg-right rtl:bg-left bg-no-repeat max-[650px]:!bg-none bg-contain" style="background-image: url({{ asset('assets/images/breadcrumb-el-1.png') }})">
            <h2 class="mb-3 xxxl:mb-5">Modifier le client</h2>
            <ul class="flex flex-wrap gap-2 items-center">
                ...
                <li>
                    <a class="flex items-center gap-2 text-primary-300" href="#">
                        <i class="las text-lg xl:text-xl xxl:text-2xl la-edit shrink-0"></i>
                        <span>Modifier</span>
                    </a>
                </li>
            </ul>
    ...
    <div class="white-box">
        <h4 class="bb-dashed-n30">Modifier les informations du client</h4>
                    ...
                    <div class="lg:px-4 xl:px-6">
                        ...
                        <div class="grid grid-cols-2 gap-4 xxl:gap-6 my-6">
                            ...
                            <div class="col-span-2 md:col-span-1">
                                <div class="relative flex items-center gap-4 rounded-xl border border-neutral-40 w-full px-4 dark:border-neutral-500 lg:px-6">
                                    ...
                                    <input type="text" id="code" name="code" value="{{ old('code', $client->code) }}" readonly
                            ...
                            <div class="col-span-2 md:col-span-1">
                                <div class="relative flex items-center gap-4 rounded-xl border border-neutral-40 w-full px-4 dark:border-neutral-500 lg:px-6">
                                    ...
                                    <input type="tel" id="mobile" name="mobile" value="{{ old('mobile', $client->mobile) }}"
                                           class="w-full s-text bg-transparent py-2.5 xl:py-3.5"
                        ...
                        <div class="grid grid-cols-2 gap-4 xxl:gap-6">
                            ...
                            <div class="col-span-2 md:col-span-1">
                                <div class="relative flex items-center gap-4 rounded-xl border border-neutral-40 w-full px-4 dark:border-neutral-500 lg:px-6">
                                    ...
                                    <input type="text" id="contact_person" name="contact_person" value="{{ old('contact_person', $client->contact_person) }}"
                                           class="w-full s-text bg-transparent py-2.5 xl:py-3.5"
                        ...
                        <div class="grid grid-cols-2 gap-4 xxl:gap-6">
                            ...
                            <div class="col-span-2 md:col-span-1">
                                <div x-data="{
                                    selectOpen: false,
                                    selectedItem: { title: '{{ $client->country }}', flag: '' },
                                    searchText: '{{ $client->country }}',
                                    optionList: [],
                                    async fetchCountries() {
                                        try {
                                            ...
                                            if (this.selectedItem.title) {
                                                const found = this.optionList.find(o => o.title === this.selectedItem.title);
                                                if (found) this.selectedItem.flag = found.flag;
                                            }
                                        } catch (error) {
                        ...
                        <div class="grid grid-cols-2 gap-4 xxl:gap-6">
                            ...
                            <div class="col-span-2 md:col-span-1">
                                <div class="relative flex items-center gap-4 rounded-xl border border-neutral-40 w-full px-4 dark:border-neutral-500 lg:px-6">
                                    ...
                                    <input type="text" id="tax_number" name="tax_number" value="{{ old('tax_number', $client->tax_number) }}"
                                           class="w-full s-text bg-transparent py-2.5 xl:py-3.5"
                        ...
                        <div class="grid grid-cols-2 gap-4 xxl:gap-6">
                            ...
                            <div class="col-span-2 md:col-span-1">
                                <div x-data="{ isOpen: false, selected: '{{ old('status', $client->status) }}' }" class="relative">
                            ...
                            <div class="col-span-2">
                                <div class="relative flex items-center gap-4 rounded-xl border border-neutral-40 w-full px-4 dark:border-neutral-500 lg:px-6">
                                    ...
                                    <textarea id="notes" name="notes" rows="3"
                                              ...
                                              placeholder="Informations supplémentaires sur le client...">{{ old('notes', $client->notes) }}</textarea>
                                </div>
                            </div>
                        </div>
