...
@section('title', 'Paiement Orange Money - Abonnement')
    ...
    <div class="container mx-auto px-4 max-w-md">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="bg-gradient-to-r from-orange-500 to-orange-600 px-6 py-8 text-white text-center">
                ...
                <p class="text-orange-100">Paiement sécurisé</p>
            </div>

            <div class="p-6">
                <div class="mb-6 text-center">
                    <p class="text-gray-600">Abonnement Premium Annuel</p>
                    <p class="text-4xl font-bold text-orange-600">{{ number_format($amount, 0, ',', ' ') }} FCFA</p>
                </div>
                ...
                <form method="POST" action="{{ route('payments.orange-money.initiate') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            ...
                            <input type="tel" 
                                   name="phone_number" 
                                   value="{{ old('phone_number', auth()->user()->company->orange_money_phone ?? '') }}"
