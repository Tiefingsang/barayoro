            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition {{ $plan->is_popular ? 'ring-2 ring-orange-custom transform scale-105' : '' }}">
                    ...
                    <div class="p-8">
                        ...
                        <a href="{{ route('register') }}" class="block w-full text-center px-6 py-3 rounded-lg font-semibold transition mb-8 {{ $plan->is_popular ? 'gradient-bg text-white' : 'border-2 border-orange-custom text-orange-custom hover:bg-orange-custom hover:text-white' }}">
